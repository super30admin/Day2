...
# Approach
# Create a list with len approximately equal to the squareroot of total elements, increase the length if needed inder to optimize the search
# For each index, create a linked list to hold elements in the range. Linkedlist will make removal of element faster and give better efficiency than another list for each element.
